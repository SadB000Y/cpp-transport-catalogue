...
namespace svg
{
    ...
    struct ColorPrint
    {
        ...
        {
            out << "rgb(" << static_cast<int>(memb.red) << "," << static_cast<int>(memb.green) << "," << static_cast<int>(memb.blue) << ")";
        }

        void operator()(Rgba memb)
        {
            out << "rgba(" << static_cast<int>(memb.red) << "," << static_cast<int>(memb.green) << "," << static_cast<int>(memb.blue) << "," << memb.opacity << ")";
        }
