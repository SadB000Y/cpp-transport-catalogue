...
void TransportRouter::AddRoundtripBusToGtaph(graph::DirectedWeightedGraph<double>& result, const transport_catalogue::Buses& bus)
{
    const auto curr_stops = bus.stops;
...
void TransportRouter::AddDirectBusToGraph(graph::DirectedWeightedGraph<double>& result, const transport_catalogue::Buses& bus)
{
    const auto curr_stops = bus.stops;
